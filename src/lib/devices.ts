...
import { VibrationSensor } from './Sensors/VibrationSensor';
import { Plug } from './Sensors/Plug';
import { Button } from './Sensors/Button';
import { Cube } from './Sensors/Cube';
import { WallButtons } from './Sensors/WallButtons';
import { WallWiredSwitch } from './Sensors/WallWiredSwitch';
import { Alarm } from './Sensors/Alarm';
import { Curtain } from './Sensors/Curtain';
import { WaterSensor } from './Sensors/WaterSensor';
import { Lock } from './Sensors/Lock';
import { Relay } from './Sensors/Relay';
...
const states: Record<string, ioBroker.StateCommon> = {
    ...
    power_consumed: {
        ...
        type: 'number',
        unit: 'Wh',
    }, // That's right, not kWh
    inuse: { name: 'Is in use', role: 'state', write: false, read: true, type: 'boolean' },
...
export const Devices: Record<string, DeviceDefinition> = {
    ...
    acpartner3: {
        type: 'acpartner.v3',
        fullName: 'Xiaomi Aqara AC partner Gateway',
        ClassName: Gateway,
        states: {
            illumination: {
                name: 'Illumination',
            ...
            relay_status: {
                name: 'Air conditioning relay control',
                role: 'state',
                write: true,
                read: true,
                type: 'string',
    ...
    th: {
        type: 'sensor_ht',
        fullName: 'Xiaomi Temperature/Humidity',
        ClassName: THSensor,
        states: {
    ...
    weather: {
        type: 'weather.v1',
        fullName: 'Xiaomi Temperature/Humidity/Pressure',
        ClassName: THSensor,
        states: {
            voltage: states.voltage,
            percent: states.percent,
    ...
    button: {
        type: 'switch',
        fullName: 'Xiaomi Wireless Switch',
        ClassName: Button,
        states: {
            voltage: states.voltage,
            percent: states.percent,
    ...
    button2: {
        type: 'sensor_switch.aq2',
        fullName: 'Xiaomi Wireless Switch Sensor',
        ClassName: Button,
        states: {
            voltage: states.voltage,
            percent: states.percent,
    ...
    button4: {
        type: 'remote.b1acn01',
        fullName: 'Xiaomi Aqara Smart Wireless Switch',
        ClassName: Button,
        states: {
            voltage: states.voltage,
            percent: states.percent,
    ...
    plug86: {
        type: '86plug',
        fullName: 'Xiaomi Smart Wall Plug',
        ClassName: Plug,
        states: {
            voltage: states.voltage,
            percent: states.percent,
    ...
    remote_b286acn01: {
        type: 'remote.b286acn01',
        fullName: 'Xiaomi Aqara Wireless Remote Switch (Double Rocker)',
        ClassName: WallButtons,
        states: {
            voltage: states.voltage,
            percent: states.percent,
    ...
    remote_b286acn02: {
        type: 'remote.b286acn02',
        fullName: 'Xiaomi Aqara Wireless Remote Switch D1 (Double Rocker)',
        ClassName: WallButtons,
        states: {
            voltage: states.voltage,
            percent: states.percent,
    ...
    remote_b186acn01: {
        type: 'remote.b186acn01',
        fullName: 'Xiaomi Aqara Wireless Remote Switch (Single Rocker)',
        ClassName: WallButtons,
        states: {
            voltage: states.voltage,
            percent: states.percent,
    ...
    remote_b186acn02: {
        type: 'remote.b186acn02',
        fullName: 'Xiaomi Aqara Wireless Remote Switch D1 (Single Rocker)',
        ClassName: WallButtons,
        states: {
            voltage: states.voltage,
            percent: states.percent,
    ...
    aqara_relay: {
        type: 'relay.c2acn01',
        fullName: 'Aqara Two-channel Relay',
        ClassName: Relay,
        states: {
    ...
    sw2_86: {
        type: '86sw2',
        fullName: 'Xiaomi Wireless Dual Wall Switch',
        ClassName: WallButtons,
        states: {
            voltage: states.voltage,
            percent: states.percent,
    ...
    sw1_86: {
        type: '86sw1',
        fullName: 'Xiaomi Wireless Single Wall Switch',
        ClassName: WallButtons,
        states: {
            voltage: states.voltage,
            percent: states.percent,
    ...
    natgas: {
        type: 'natgas',
        fullName: 'Xiaomi Mijia Honeywell Gas Alarm Detector',
        ClassName: Alarm,
        states: {
            voltage: states.voltage,
            percent: states.percent,
    ...
    smoke: {
        type: 'smoke',
        fullName: 'Xiaomi Mijia Honeywell Fire Alarm Detector',
        ClassName: Alarm,
        states: {
            voltage: states.voltage,
            percent: states.percent,
    ...
    ctrl_ln1: {
        type: 'ctrl_ln1',
        fullName: 'Xiaomi Aqara 86 Fire Wall Switch One Button',
        ClassName: WallWiredSwitch,
        states: {
    ...
    ctrl_ln1_aq1: {
        type: 'ctrl_ln1.aq1',
        fullName: 'Xiaomi Aqara Wall Switch LN',
        ClassName: WallWiredSwitch,
        states: {
            channel_0: states.wall_switch,
        },
    ...
    ctrl_ln2: {
        type: 'ctrl_ln2',
        fullName: 'Xiaomi 86 zero fire wall switch double key',
        ClassName: WallWiredSwitch,
        states: {
    ...
    ctrl_ln2_aq1: {
        type: 'ctrl_ln2.aq1',
        fullName: 'Xiaomi Aqara Wall Switch LN double key',
        ClassName: WallWiredSwitch,
        states: {
            channel_0: states.wall_switch0,
            channel_1: states.wall_switch1,
    ...
    ctrl_86plug: {
        type: 'ctrl_86plug',
        fullName: 'Xiaomi Aqara Wall Socket',
        ClassName: Plug,
        states: {
            voltage: states.voltage,
            percent: states.percent,
    ...
    ctrl_neutral2: {
        type: 'ctrl_neutral2',
        fullName: 'Xiaomi Wired Dual Wall Switch',
        ClassName: WallWiredSwitch,
        states: {
            channel_0: states.wall_switch0,
            channel_1: states.wall_switch1,
    ...
    ctrl_neutral1: {
        type: 'ctrl_neutral1',
        fullName: 'Xiaomi Wired Single Wall Switch',
        ClassName: WallWiredSwitch,
        states: {
            channel_0: states.wall_switch,
        },
    ...
    // for protocol v1
    ctrl_neutral2_b2nacn02p1: {
        type: 'switch_b2nacn02',
        fullName: 'Aqara D1 2 gang smart wall switch (with neutral wire)',
        ClassName: WallWiredSwitch,
        states: {
            channel_0: states.wall_switch0,
            channel_1: states.wall_switch1,
    ...
    // for protocol v2
    ctrl_neutral2_b2nacn02p2: {
        type: 'switch.b2nacn02',
        fullName: 'Aqara D1 2 gang smart wall switch (with neutral wire)',
        ClassName: WallWiredSwitch,
        states: {
            channel_0: states.wall_switch0,
    ...
    curtain: {
        type: 'curtain',
        fullName: 'Xiaomi Aqara Smart Curtain',
        ClassName: Curtain,
        states: {
            curtain_level: {
                name: 'Curtain level',
    ...
    lock_v1: {
        type: 'lock.v1',
        fullName: 'Xiaomi Vima Smart Lock',
        ClassName: Lock,
        states: {
            voltage: states.voltage,
            percent: states.percent,
    ...
    vibration: {
        type: 'vibration',
        fullName: 'Xiaomi Vibration Sensor',
        ClassName: VibrationSensor,
        states: {
            voltage: states.voltage,
            percent: states.percent,
    ...
    wleak1: {
        type: 'sensor_wleak.aq1',
        fullName: 'Xiaomi Aqara Water Sensor',
