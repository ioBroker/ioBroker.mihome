...
const devices = {
    ...
    acpartner3:             {type: 'acpartner.v3',    fullName: 'Xiaomi Aqara AC partner Gateway', ClassName: Gateway, states: {
            ...
            temp_cfg:       {name: 'Air conditioning temperature',      role: 'level.temperature',          write: true, read: true,  type: 'number'},
    ...
    remote_b286acn02: {type: 'remote.b286acn02',   fullName: 'Xiaomi Aqara Wireless Remote Switch D1 (Double Rocker)', ClassName: WallButtons, states: {
            voltage:          states.voltage,
            percent:          states.percent,
    ...
    remote_b186acn02: {type: 'remote.b186acn02',   fullName: 'Xiaomi Aqara Wireless Remote Switch D1 (Single Rocker)', ClassName: WallButtons, states: {
            voltage:          states.voltage,
            percent:          states.percent,
